<template>
  ...
  <div>
    <div class="box">
      <div class="head_groundEnd">
        <el-card class="head_groundEnd_card">
          <el-tabs
            @tab-click="handleClick"
            class="head_groundEnd_tabs"
            v-model="activeName"
          >
            <el-tab-pane label="司机账号管理" name="driver"> </el-tab-pane>
            <el-tab-pane label="地面端账号管理" name="groundEnd">
              <div class="groundEnd_tabs_nr">
                <div>
                  <el-button class="groundEnd_btn" @click="groundEndAdd"
                    >添加账号</el-button
                  >
                </div>
                <div class="nr_input">
                  <el-input
                    class="groundEnd_input"
                    size="small"
                    placeholder="搜索"
              ...
              <div class="groundEnd_table">
                <el-card>
                  ...
                  <div class="groundEnd_footer">
                    <div></div>
                    <div class="groundEnd_Pagination">
                      <el-pagination
    ...
    <!-- 弹框 -->
    <div class="groundEnd_dialog">
      <el-dialog 
       @close="addDialog"
      :title="titleDialog" :visible.sync="centerDialogVisible">
            ...
            <el-form-item label="权限信息" prop="d_id" label-width="90px">
              <div class="div_input">
                <div class="content_input1">
                  <div>
                    <el-radio-group v-model="ruleForm.d_id">
                      <el-radio :label="1">首页</el-radio>
                      <el-radio :label="2">应急指挥</el-radio>
                      <el-radio :label="3">行车日志</el-radio>
                      <el-radio :label="4">辅助驾驶</el-radio>
                      <el-radio :label="5">系统管理</el-radio>
                    </el-radio-group>
                  </div>
                </div>
              </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        d_id: [
          { required: true, message: "请选择权限信息", trigger: "change" },
        ],
        remark: [{ required: true, message: "请输入备注", trigger: "blur" }],
      },

      activeName: "groundEnd",
      input2: "",
      tableData: [],
      options: [
        {
